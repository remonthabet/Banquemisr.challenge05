...
final class GetNowPlayingMoviesTestCase: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        nowPlayingUseCase = GetNowPlayingUseCase(moviesRepository: mockRepository)
    }
    ...
    func testCase_testMoviesSavedInDB() async throws {
        ...
        let movies = try await nowPlayingUseCase.fetch()
        mockDBManager.saveMovies(movies, for: .nowPlaying)
